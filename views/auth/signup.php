...
<form method="post" action="/signup">
    <div class="field">
        ...
        <?php if (app()->session->hasFlash('errors')): ?>
            <p class="has-text-danger">
                <?= (app()->session->exists('name')) ? app()->session->getFlash('errors')['name'][0]: ''; ?>
            </p>
        <?php endif; ?>
    </div>
    ...
    <div class="field">
        ...
        <?php if (app()->session->hasFlash('errors')): ?>
        <p class="has-text-danger">
            <?= (app()->session->exists('username')) ? app()->session->getFlash('errors')['username'][0] : ''; ?>
        </p>
        <?php endif; ?>
    </div>
    ...
    <div class="field">
        ...
        <?php if (app()->session->hasFlash('errors')): ?>
        <p class="has-text-danger">
            <?= (app()->session->exists('password_confirmation')) ? app()->session->getFlash('errors')['password_confirmation'][0]: ''; ?>
        </p>
        <?php endif; ?>
    </div>
